...
// Author: Dieter Oberkofler <https://github.com/doberkofler>
 ...
 */
declare class JQueryGenericPromise<T> {
  /**
 ...
 */
declare class JQueryPromise<T> extends JQueryGenericPromise<T> {
  /**
 ...
 */
declare class JQueryDeferred<T> extends JQueryGenericPromise<T> {
  /**
   * Determine the current state of a Deferred object.
   */
  state(): string;
...
declare class JQueryInputEventObject extends BaseJQueryEventObject {
  altKey: boolean;
  ctrlKey: boolean;
  metaKey: boolean;
  shiftKey: boolean;
...
declare class JQueryMouseEventObject extends JQueryInputEventObject {
  button: number;
  clientX: number;
  clientY: number;
  offsetX: number;
...
declare class JQueryKeyEventObject extends JQueryInputEventObject {
  char: any;
  charCode: number;
  key: any;
  keyCode: number;
...
/**
 * The class used to construct jQuery events (with $.Event). It is
...
declare class JQueryStatic {
  ...
  /**
   * Returns value: any at named data store for the element, as set by jQuery.data(element, name, value), or the full data store for the element.
   *
   * @param element The DOM element to associate with the data.
   * @param key A string naming the piece of data to set.
   */
   ...
   * @param context The object to which the context (this: any) of the function should be set.
...
declare class JQuery {
   ...
   */
  attr(attributeName: string, _: void): string;
   ...
   */
  css(propertyName: string, _: void): string;
   ...
   */
  hover(handlerInOut: (eventObject: JQueryEventObject) => any, _: void): JQuery;

  /**
   * Trigger the "keydown" event on an element.
   */
  keydown(_: void): JQuery;
  /**
   ...
   *
   * @param target A s: anyelector, element, HTML string, array of elements, or jQuery object; the matched set of elements will be inserted at the end of the element(s) specified by this parameter.
   */
   ...
   *
   * param target A s: anyelector, element, array of elements, HTML string, or jQuery object; the matched set of elements will be inserted after the element(s) specified by this parameter.
   */
   ...
   *
   * param target A s: anyelector, element, array of elements, HTML string, or jQuery object; the matched set of elements will be inserted before the element(s) specified by this parameter.
   */
   ...
   *
   * @param target A s: anyelector, element, HTML string, array of elements, or jQuery object; the matched set of elements will be inserted at the beginning of the element(s) specified by this parameter.
   */
   ...
   *
   * @param target A s: anyelector string, jQuery object, DOM element, or array of elements indicating which element(s) to replace.
   */
   ...
   * @param context: any The point in the document at which the selector should begin matching; similar to the context argument of the $(selector, context) method.
   */
