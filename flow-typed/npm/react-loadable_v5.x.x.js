...
declare module 'react-loadable' {
  ...
  declare type OptionsWithoutRender<TProps> = {
    ...CommonOptions,
    loader(): Promise<
      React$ComponentType<TProps> | { default: React$ComponentType<TProps> }
    >,
  };
  ...
  declare type Options<TProps, TModule> =
    | OptionsWithoutRender<TProps>
    | OptionsWithRender<TProps, TModule>;
  ...
  declare module.exports: {
    ...
    ): Class<LoadableComponent<TProps>>,
    Map<TProps, TModules>(
